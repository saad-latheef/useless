...
import { MUNDU_SYSTEM_INSTRUCTION, MUNDU_ANALYSIS_PROMPT } from '@/lib/ai-constants';
...
export async function POST(request) {
  try {
    ...
    const analysisResult = await analyzeImageWithAI(
      imageData,
      MUNDU_SYSTEM_INSTRUCTION,
      MUNDU_ANALYSIS_PROMPT,
      additionalInfo
    );
    ...
    console.error('Mundu analysis route error:', error);
    return NextResponse.json(
